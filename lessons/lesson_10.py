...
(
    INTEGER, PLUS, MINUS, MUL, LPAREN, RPAREN, ID,
    BEGIN, END, EOF, ASSIGN, SEMI, DOT, PROGRAM, VAR, REAL,
    COLON, COMMA, INTEGER_CONST, REAL_CONST, INTEGER_DIV,
    FLOAT_DIV
) = (
    'INTEGER', 'PLUS', 'MINUS', 'MUL', '(', ')', 'ID',
    'BEGIN', 'END', 'EOF', 'ASSIGN', 'SEMI', 'DOT', 'PROGRAM',
    'VAR', 'REAL', 'COLON', 'COMMA', 'INTEGER_CONST', 'REAL_CONST',
